...
class PlaylistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create playlist" do
    assert_difference('Playlist.count') do
      post playlists_url, params: { playlist: { category: @playlist.category, link: @playlist.link, title: @playlist.title, views: @playlist.views } }
    end
  ...
  test "should update playlist" do
    patch playlist_url(@playlist), params: { playlist: { category: @playlist.category, link: @playlist.link, title: @playlist.title, views: @playlist.views } }
